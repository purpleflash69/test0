...
class _AppDrawerState extends State<AppDrawer> {
  ...
  double gaugeMin = 0;
  double gaugeMax = 100;
  double gaugeCurrent = 29; //This shows when the app is opened.
          ...
          axes: <RadialAxis>[
            RadialAxis(
                ...
                annotations: <GaugeAnnotation>[
                  GaugeAnnotation(
                      widget: Container(
                          child: Text(gaugeCurrent.toString(),
                              style: TextStyle(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    setState(() {
                      ...
                      gaugeCurrent = gaugeCurrentForCharge;
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    setState(() {
                      ...
                      gaugeCurrent = gaugeCurrentForkWh;
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    setState(() {
                      ...
                      gaugeCurrent = gaugeCurrentForRange;
